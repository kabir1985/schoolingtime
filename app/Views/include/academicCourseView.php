  ...
  <section id="blog" class="blog">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="sidebar">
            <h3 class="sidebar-title">একাডেমিক কোর্স</h3>
            <hr>
            <div class="sidebar-item categories">
              <ul>
                <?php foreach ($academicCosurseList as $row): ?>
                  <li>
                    <a href="<?php echo site_url('course-show-academic') . '/' . $row->course_category_id; ?>">
              ...
              <div class="row gy-4">
                <?php foreach ($academicCosurseList as $row): ?>
                  ...
                  foreach ($course_info as $row1):
                    $course_status = $row1->course_status;
                  ?>
                    <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                      <a href="<?php echo site_url('/course-details-page') . '/' . $row1->course_id; ?>">
                        <div class="service-box blue">
                          ...
                          <h5 class="pt-3"><?php echo htmlspecialchars($row1->coures_title); ?></h5>
                          ...
                          <div class="flex-container bg-light">
                            <div>কোর্স ফি:&nbsp;<?php echo convertToBanglaNumber($row1->course_price); ?>&nbsp;টাকা</div>
                          </div>
                        </div>
                      </a>
                    </div>
