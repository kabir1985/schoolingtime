          ...
          <div class="sidebar">
            ...
            <div class="sidebar-item categories">
              <ul>
                ...
                ?>
                  <li>
                    <a href="<?php echo site_url('course-show-academic') . '/' . $row->course_category_id; ?>"><?php echo $row->course_category_name; ?><span class="float-end">(25)</span></a>
                  </li>
                <?php
                } ?>
              </ul>
        ...
        <div class="col-lg-9 entries">
          ...
          <section id="services" class="services">
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row gy-4">
                <?php
                foreach ($academic_course_show as $row) {
